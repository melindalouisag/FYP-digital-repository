...
public class LibraryReviewService {
  ...
  public List<StudentCaseSummaryResponse> reviewQueue(CaseStatus status, PublicationType type) {
    ...
    List<PublicationCase> reviewCases = cases.findByStatusInOrderByUpdatedAtDesc(statuses).stream()
