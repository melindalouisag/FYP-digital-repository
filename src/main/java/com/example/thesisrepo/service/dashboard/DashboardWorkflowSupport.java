...
public final class DashboardWorkflowSupport {
  ...
  private static StageBucket stageBucket(CaseStatus status) {
    return switch (status) {
      ...
      case FORWARDED_TO_LIBRARY, UNDER_LIBRARY_REVIEW, NEEDS_REVISION_LIBRARY, APPROVED_FOR_CLEARANCE -> StageBucket.LIBRARY_REVIEW;
      case CLEARANCE_SUBMITTED, CLEARANCE_APPROVED, READY_TO_PUBLISH -> StageBucket.CLEARANCE;
